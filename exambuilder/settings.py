...
EMAIL_USE_TLS = env_to_bool('EMAIL_USE_TLS', default=True)
STRIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY', '')
STRIPE_PUBLISHABLE_KEY = os.getenv('STRIPE_PUBLISHABLE_KEY', '')
STRIPE_WEBHOOK_SECRET = os.getenv('STRIPE_WEBHOOK_SECRET', '')
STRIPE_PRICE_ID = os.getenv('STRIPE_PRICE_ID', '')
STRIPE_PRICE_ID_GCSE = os.getenv('STRIPE_PRICE_ID_GCSE', '')
STRIPE_PRICE_ID_ALEVEL = os.getenv('STRIPE_PRICE_ID_ALEVEL', '')
STRIPE_PRICE_ID_BOTH = os.getenv('STRIPE_PRICE_ID_BOTH', '')
STRIPE_CHECKOUT_MODE = os.getenv('STRIPE_CHECKOUT_MODE', 'payment')
STRIPE_SUCCESS_URL = os.getenv('STRIPE_SUCCESS_URL', f'{FRONTEND_URL}/account?checkout=success')
STRIPE_CANCEL_URL = os.getenv('STRIPE_CANCEL_URL', f'{FRONTEND_URL}/account?checkout=cancelled')
